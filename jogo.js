...
//Variaveis de estado jogo

let cobra = []; //Armazena a posição da cobra
let direcao = {x: 1, y: 0} //Direção do movimento
let proximaDirecao = {x: 1, y: 0} //Direcao da proxima tickada
let comida = {x: 0, y: 0} //Armazena a posição da comida
let pontuacao = 0;
let recorde = parseInt(localStorage.getItem("recorde_cobra")) || 0;
let intervalo = null; //Referencia do setIntervalo do loop infinito
let emJogo = false;

//Grade do jogo

const grade = document.getElementById('grade');
let celulas = []; //Referencia as celulas da grade
